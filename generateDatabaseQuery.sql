...
INSERT INTO UserAccount (username, pass) 
    ...
    ('rep115932', 'HW)<;46jE<E*g,#}'),
    ('rep192052', '3Y38%L)F:d8dYp&4');
    
UPDATE Administrator, UserAccount
    SET Administrator.username = UserAccount.username
    AND Administrator.pass = UserAccount.pass
    WHERE UserAccount.username = 'root';
    
UPDATE CustomerRep, UserAccount
    SET CustomerRep.username = UserAccount.username
    AND CustomerRep.pass = UserAccount.pass
    WHERE UserAccount.username = 'rep%';
 
 INSERT INTO Administrator (email, username, pass) 
    VALUES ('root@buyMe.com', 'root', 'UN5AW!]x9K{[bP');
    
INSERT INTO CustomerRep (email, username, pass) 
    VALUES ('rep115932@buyMe.com', 'rep115932', 'HW)<;46jE<E*g,#}'),
    ('rep192052@root.com', 'rep192052', '3Y38%L)F:d8dYp&4');
